	...
	*/
	$.extend({  
        ...
        tooltip: function (t1, t2, t3, callback) {
        		...
        		var tip = '<div class="HTooltip shake animated" style="display:none;width:280px;padding:10px;text-align:center;background-color:#D84C31;color:#fff;position:fixed;top:10px;left:50%;z-index:100001;margin-left:-150px;box-shadow:1px 1px 5px #333;-webkit-box-shadow:1px 1px 5px #333;">'+t1+'</div>';
	    		if(t3 == true && t3 != undefined) { 
					tip = '<div class="HTooltip bounceInDown animated" style="display:none;width:280px;padding:10px;text-align:center;background-color:#5cb85c;color:#fff;position:fixed;top:10px;left:50%;z-index:100001;margin-left:-150px;box-shadow:1px 1px 5px #333;-webkit-box-shadow:1px 1px 5px #333;">'+t1+'</div>'; }
...
function alert_text(a){
	$.dialog('confirm','提示',a,0,function(){ 
		$.closeDialog(); 
	});	
}
$(".btn").click(function(){
	confirm_text("aaaa",textq());
})

function confirm_text(a,b){
	$.dialog('confirm','提示',a,0,function(){
		$.tooltip(a,0,true,function(){
			$.closeDialog(b);
		});
	});
}
